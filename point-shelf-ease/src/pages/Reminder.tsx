...
export default function Reminder() {
  ...
  const links = [
    { to: `${base}`, label: 'List', icon: Bell, end: true },
  ...
  return (
    <div className="space-y-8 p-1 bg-gradient-subtle min-h-screen">
      <div className="rounded-xl p-6 border-2 bg-white border-border shadow-lg">
        <h1 className="text-4xl font-bold tracking-tight mb-2 text-foreground bg-gradient-hero bg-clip-text text-transparent">Reminders</h1>
        <p className="text-lg text-muted-foreground">Manage important reminders and notifications</p>
